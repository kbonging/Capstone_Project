...
export default function ProfileStats({ user, userRole }) {
  ...
  if (userRole === "ROLE_OWNER") {
    return (
      <div className="space-y-4 font-['Noto_Sans_KR',sans-serif]">
  ...
  if (userRole === "ROLE_USER") {
    return (
      <div className="space-y-4 font-['Noto_Sans_KR',sans-serif]">
        <div className="w-full px-4 py-3 border rounded-xl font-semibold">
          <p className="text-sm text-gray-800">{user.intro || "미등록"}</p>
        </div>
